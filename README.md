...
1. 设置`MAA路径`后，单击`设置MAA`进行MAA基础设置。

2. 在打开的MAA界面完成`性能设置`、`游戏设置`、`连接设置`、`启动设置`、`界面设置`、`软件更新`等基本配置。
