...
export default {
  ...
  edit: {
    ...
    zzzodRestoreViewNoteOd:
      'Restores this backup to the OneDragon (current config is backed up first and can be restored anytime), then opens the OneDragon for inspection',
    zzzodRestoreViewNoteMas:
      'Restores this backup to your dedicated instance (current config is backed up first and can be restored anytime), then opens the OneDragon for inspection',
    ...
    zzzodModeDirectDesc: 'Edit the selected instance\'s native one-dragon config',
    zzzodDirectInstance: 'Select instance',
    zzzodDirectInstanceHint: 'Pick the one-dragon account (instance) to edit directly',
    ...
    zzzodDirectInstanceRunHint:
      'Run current only = run just the selected account; run all instances = run every account in the one-dragon\'s own order',
    zzzodInstanceRunCurrent: 'Run current only',
    zzzodInstanceRunAll: 'Run all instances',
    ...
    zzzodDirectTasksDesc:
      'Task switches and order below are written straight back to the selected instance\'s native task list; flip a switch to include it, use the arrows to reorder.',
    ...
    zzzodOneDragonDesc:
      'One-dragon series tasks on one screen: flip a switch to include a task in the run; use the arrows to adjust the run order.',
