...
export default {
  ...
  edit: {
    ...
    bettergiMasConfigTooltip: 'Per-user mode: this user\'s One Dragon tasks and custom groups are configured entirely on this page (MAS is the source of truth); there is no need to edit the MAS independent profile inside BetterGI.',
    ...
    bettergiDirectModeAlert: 'Script-controlled mode: enter the OneDragon config name this user uses below (a config that already exists in BetterGI); configure scripts inside BetterGI (click "Configure BetterGI" to open it).',
    bettergiSwitchToMasConfig: 'Switch to per-user config',
    bettergiMasConfigHowTo: 'How to use per-user config',
    bettergiMasConfigHowTo1a: "This user's One Dragon is on a per-user profile: tasks and custom groups are configured on this page as the MAS source of truth (no need to open BetterGI's One Dragon page). MAS launches One Dragon from the fixed slot",
    bettergiMasConfigSlotName: 'MAS独立配置',
    bettergiMasConfigHowTo1b: 'and cleans the slot up afterwards. Your own BetterGI profiles (such as 默认配置) stay untouched: the same-named real profile is neither read nor affected by this page.',
    ...
    bettergiOneDragonNameHint: 'Fixed to MAS独立配置 while per-user config is on and cannot be changed. With per-user config off (direct mode) it picks the BetterGI profile to use; defaults to 默认配置',
    ...
    bettergiStrategyPickerTip: 'Click an option above to select it (single choice); leave empty to pick automatically from the party',
    ...
    bettergiGroupStamina: 'Stamina Combat',
    bettergiGroupKindStamina: 'MAS',
    bettergiGroupKindCustom: 'Script',
    bettergiGroupKindJs: 'JS',
    bettergiGroupKindJsDesc: 'Custom JS scripts from the BetterGI script directory User/JsScript; each can run as its own OneDragon task (the folder name is the task name). Once added, AUTO-MAS manages its toggle as a config group.',
    bettergiGroupsDragHint: 'Drag the handle on the left to reorder config groups (order will take effect once backend support lands).',
    bettergiGroupStaminaHint: 'Stamina Combat is a virtual config group added by the AUTO-MAS module (the 9th entry): it consumes resin smartly per the weekly schedule (ley lines / domains / boss battles). This toggle is a frontend placeholder for now; it will join OneDragon execution once the backend is wired up.',
    bettergiGroupsEmptyRight: 'Select a config group on the left to view its description and toggle.',
    bettergiGroupPrefixDefault: 'Default',
    bettergiGroupFrozen: 'Frozen',
    bettergiGroupFrozenTip: 'Stamina Combat is enabled, so built-in farming groups are temporarily frozen. Disable or remove Stamina Combat to re-enable them.',
    bettergiAddToDragon: 'Add config group',
    bettergiAddToDragonOk: 'Add to OneDragon',
    bettergiPickCandidateFirst: 'Click a config group below',
    bettergiAlreadyInDragon: 'This group is already in OneDragon',
    bettergiInQueue: 'In queue',
    bettergiDuplicateAsNew: 'Save as new group',
    bettergiCopySameAs: 'Duplicate same group',
    ...
    bettergiDuplicateNameTaken: '"{name}" already exists in your current OneDragon, please choose another name',
    bettergiDuplicateDone: 'Saved as new group "{name}" and added to queue',
    bettergiDuplicateSameDone: 'Added a duplicate of group "{name}" to the queue',
    bettergiRemoveFromDragonTitle: 'Remove from OneDragon',
    bettergiRemoveFromDragonContent: 'Remove "{name}" from OneDragon? You can re-add it later via "Add config group".',
    bettergiClearDragon: 'Clear all',
    bettergiClearDragonTitle: 'Clear OneDragon',
    bettergiClearDragonContent: 'Clear the whole OneDragon? All config groups will be removed and you can add them again manually.',
    bettergiInputGroupNames: 'Type a config group name and press Enter, or click a candidate below',
    bettergiInputGroupNamesTip: 'Bubbles are selected groups, colored by type; click × to remove. Clicking a candidate/pathing file adds a bubble. Press Enter or ";" to confirm typed names (unrecognized names are blocked).',
    bettergiGroupNamesUnknown: 'Unrecognized config groups: {names}',
    ...
    bettergiCustomGroupsTip3: 'Add group picks from your existing BetterGI profile (the user MAS independent copy under per-user mode) which groups to manage here. Groups left out stay in One Dragon and are never dropped because of this table.',
    ...
    bettergiOpenScriptRepo: 'Open script repo',
    bettergiOpenScriptDir: 'Open script folder',
    bettergiOpenTaskDir: 'Open AutoPathing folder',
    bettergiOpenOneDragonDir: 'Open OneDragon folder',
    bettergiOpenScriptGroupDir: 'Open config-group folder',
    bettergiOpenBgi: 'Open BGI',
    bettergiMultiSelectHint: 'Shift-click to select a range, Ctrl-click to select one by one',
    bettergiMultiRemove: 'Remove selected',
    bettergiMultiEnable: 'Enable all',
    bettergiMultiDisable: 'Disable all',
    bettergiMultiSelected: '{count} selected',
    bettergiChipSelectHint: 'Click to select / drag to select range; Ctrl to toggle; Shift for range; Backspace or Delete to remove selected chips',
    bettergiProjectUnselect: 'Deselect',
    bettergiMultiRemoveTitle: 'Remove selected config groups',
    bettergiMultiRemoveContent: 'Remove the {count} selected config groups?',
    bettergiTabScriptGroup: 'Config groups',
    bettergiTabJsScript: 'JS scripts',
    bettergiTabPathing: 'Map paths',
    bettergiScriptGroupEmptyDir: 'No config groups in User/ScriptGroup yet. Click "Open config-group folder" to add some.',
    bettergiTabJsEmpty: 'No custom JS scripts or custom groups yet. Click "Open script folder" above to browse.',
    bettergiGroupKindScriptGroup: 'Config group',
    bettergiGroupKindScriptGroupDesc: 'Custom config groups from the BetterGI config-group folder User/ScriptGroup that can be added straight to OneDragon.',
    bettergiPathingSelectHint: 'Pick a folder on the left, then click a file on the right to add a "Pathing" bubble; confirm with "Add to OneDragon".',
    bettergiPathingEmptyDir: 'No path files in this folder',
    bettergiPathingEmptyTree: 'AutoPathing folder not found. Check the BetterGI script path.',
    bettergiGroupKindPathing: 'Path',
    bettergiGroupKindPathingDesc: 'Path files from the BetterGI map-pathing folder User/AutoPathing; add them to OneDragon to run gather routes.',
    ...
    bettergiGroupSettingsTitle: 'Task settings',
    bettergiDomainPickerTitle: 'Pick domain (Region → Domain → Reward)',
    bettergiDomainPickerNone: 'No available settings',
    bettergiDomainPickerClear: 'Clear',
    bettergiDomainPickerOk: 'OK',
    bettergiDomainPickerClearAll: 'Clear all',
    bettergiDomainPickerClearAllConfirm: 'Clear domain & reward for all rows?',
    bettergiGroupSettingsSave: 'Save settings',
    bettergiGroupSettingsPlaceholder: 'Select or type',
    bettergiGroupSettingsNone: 'No settings available for this task yet',
    bettergiGroupSettingsZoom: 'Open settings in a dialog',
    bettergiGroupSettingsLoadFailed: 'Could not load task settings',
    bettergiGroupSettingsSaveFailed: 'Could not save task settings',
    bettergiGroupSettingsSaved: 'Task settings saved',
    bettergiProjectAddScript: 'Add script',
    bettergiProjectRemoveScript: 'Remove scripts',
    bettergiProjectRemoveConfirm: 'Remove the selected script projects?',
    bettergiProjectToolbarTip: 'Drag the left 2/3 area to reorder; click to select, Ctrl for multi-select, Shift for range-select',
    bettergiProjectZoom: 'Expand editing',
    bettergiProjectRowTip: 'Click to select; Ctrl to toggle multi-select; Shift for range-select; double-click to open script config',
    bettergiProjectMultiHint: 'Multiple rows selected - click "Remove scripts" to batch delete',
    bettergiProjectClearSelection: 'Clear selection',
    bettergiAddScriptToGroup: 'Add scripts to config group',
    bettergiAddScriptToGroupOk: 'Add to config group',
    bettergiAddScriptUnsupported: 'Selected items cannot be added as scripts (only JS scripts and map pathing are supported)',
    bettergiProjectListTip: 'Drag the left 2/3 area to reorder projects; double-click to open script config / description. JS/pathing appear as single-project groups.',
    bettergiProjectEmpty: 'No projects in this config group yet',
    bettergiProjectDblclickEdit: 'Double-click to open script config and description',
    bettergiProjectSettingsSave: 'Save',
    bettergiProjectSettingsDblclickTip: 'Changes are written to this user config (never overwrites the original BetterGI config)',
    bettergiProjectNoSettingsFile: 'This script folder has no settings file (settings.json) to edit',
    bettergiProjectConfigTab: 'Script config',
    bettergiProjectReadmeTab: 'Script description',
    bettergiProjectReadmeEmpty: 'This script folder has no README description',
    bettergiProjectLoadFailed: 'Could not load config-group projects',
    bettergiProjectSaveFailed: 'Could not save config-group projects',
    bettergiProjectSaved: 'Config-group projects saved to user config',
    bettergiProjectIndependentSaveLater: 'Saving settings for standalone JS/pathing will be supported in a later version',
  },
  emulator: {
    title: 'Emulators',
