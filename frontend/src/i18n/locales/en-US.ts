...
export default {
  ...
  edit: {
    ...
    baahConfigNameHint:
      'Enter an existing config file name from the BAAH UI (for example 国服2); this app launches it as BAAH.exe 国服2.json',
    baahConfigNamePlaceholder: 'For example: 国服2',
