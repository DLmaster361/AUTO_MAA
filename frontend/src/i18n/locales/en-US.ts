...
export default {
  ...
  edit: {
    ...
    managed: {
      ...
      notImportedDesc:
        'A managed script gets its project imported and slimmed by AUTO-MAS: the GUI shell, bundled Python and MaaFramework are dropped, and the runtime is shared with other scripts. Point at a local project folder or ZIP release below to import.',
      project: 'Project',
      version: 'Version',
      payloadSize: 'Payload',
      size: 'Size',
      lastUsed: 'Last used',
      action: 'Actions',
      strippedTitle: 'Slimmed by {saved} ({percent}%)',
      strippedDesc: 'Shells removed: {shells}; {count} paths excluded',
      viewExcluded: 'View excluded entries',
      sourcePath: 'Project folder or ZIP release',
      sourcePlaceholder: 'e.g. D:\\downloads\\M9A-win-x86_64-v4.6.0 or the matching .zip',
      import: 'Import',
      ...
      deleteContent: 'Only that version\'s files are removed; script config and other versions are untouched.',
      deleteBlocked: 'This version cannot be deleted',
      excludedTitle: 'Excluded entries',
      excludedPath: 'Path',
    ...
    zzzodInvalidDirectory: 'The selected directory is invalid',
    zzzodLauncherNotFound:
      'Neither {p0} nor {p1} was found in the selected directory. Pick the complete OneDragon install root.',
    zzzodNotZzzodScript: 'This script is not a ZZZ-OD script',
    ...
    zzzodTeamsSaved: 'Predefined teams saved',
    ...
    zzzodQuickImport: 'Quick import config',
    zzzodImport: 'Import',
    zzzodImportPlaceholder: 'Click to pick a template instance',
    zzzodImportConfigHint: 'Quickly generate a user config from an existing OneDragon instance',
    zzzodImportConfirmTitle: 'Overwrite current user config',
    zzzodImportConfirmDesc:
      'This will overwrite the current standalone user config with the selected instance\'s account info and enabled task list. A backup of the current config is created automatically before import and can be restored anytime via "Config restore". Import anyway?',
    zzzodImportSuccess: 'Config generated from the selected instance',
    zzzodImportFailed: 'Failed to import config',
    // ══ 通用配置恢复（configRestoreSection 组件词条，{script} 参数化脚本名）══
    configRestoreTitle: 'Config restore',
    configRestoreTargetMas: 'Restore MAS user config',
    configRestoreTargetScript: 'Restore {script} native config',
    configRestoreMasDesc:
    ...
    configRestorePreviewTasks: 'Task orchestration',
    configRestorePreviewNoTasks: 'No task orchestration in this backup',
    ...
    configRestorePreviewRegion: 'Game region',
    configRestorePreviewGamePath: 'Game path',
    configRestorePreviewLanguage: 'Game language',
    ...
    zzzodScriptNotFound: 'The ZZZ-OD script does not exist or could not be loaded',
    zzzodStopFailed: 'Could not stop the ZZZ-OD setup session',
    zzzodStartFailed: 'Could not start the ZZZ-OD setup session',
    ...
    zzzodDirectPasswordPlaceholder: 'Enter the password (required for account switching)',
    zzzodInstanceActiveTag: 'Active',
    zzzodInstanceActiveTagHint: 'Active instance — "Run current only" runs this one only',
    zzzodInstanceFlagFailed: 'Failed to update the instance participation state',
    zzzodSetActiveInstanceFailed: 'Failed to set the current active instance',
    zzzodSetInstanceActive: 'Click to set active',
    zzzodSetInstanceActiveSuccess: '{name} is now the current active instance',
    zzzodAddInstance: 'Add instance',
    zzzodAddInstanceFailed: 'Failed to add instance',
    zzzodAddInstanceSuccess: 'Instance added',
    zzzodInstanceName: 'Instance name',
    zzzodInstanceNameHint: 'Use a region or account name so it is easy to tell instances apart',
    zzzodInstanceNamePlaceholder: 'Enter the instance name',
    zzzodInstanceNameRequired: 'Instance name is required',
    zzzodRenameInstance: 'Rename',
    zzzodRenameInstanceFailed: 'Failed to rename instance',
    zzzodRenameInstanceSuccess: 'Instance renamed',
    zzzodDeleteInstance: 'Delete instance',
    zzzodDeleteInstanceConfirm:
      'Deleting instance {inst} also removes its config directory permanently (the native config is backed up first); confirm deletion?',
    zzzodDeleteInstanceFailed: 'Failed to delete instance',
    ...
    zzzodRegionUs: 'US',
    zzzodRegionEu: 'EU',
    zzzodRegionAsia: 'Asia',
    zzzodRegionTwHkMo: 'TW/HK/MO',
    zzzodGameLanguage: 'Game language',
    zzzodGameLanguageHint: 'In-game interface language (Chinese/English)',
    zzzodLanguageCn: 'Chinese',
    zzzodLanguageEn: 'English',
    zzzodGamePath: 'Game path',
    zzzodGamePathHint: 'Full path to the ZenlessZoneZero.exe client',
    zzzodGamePathPlaceholder: 'Pick ZenlessZoneZero.exe',
  ...
  emulator2: {
    ...
    colSource: 'Source',
    colSlot: 'Device',
    nativeIndex: 'instance {index}',
    footerHint:
      'Settings can be changed at any time and take effect on the next start. Start / stop / hide and script calls keep working as before.',
    ...
    settingsHint:
      'Applied on next start; a running instance keeps its current configuration. Fields left empty are not changed.',
    save: 'Save',
    keepCurrent: 'Unchanged',
    fieldWidth: 'Width',
    fieldHeight: 'Height',
    fieldDpi: 'DPI',
    fieldCpu: 'CPU cores',
    ...
    batchTitle: 'Apply settings to all instances',
    ...
    stableOn: 'On',
    stableOff: 'Off',
    stableTitle: 'Turn on stable mode',
    stableApply: 'Turn on stable mode',
    stableAlready: 'This instance already has stable mode on',
    stableIntro:
      'Turns off emulator features that interfere with screenshot recognition. Scripts match screenshots and tap fixed coordinates; these features break both assumptions.',
    stableNothing: 'Every device already has stable mode on',
    stableWillChange: '{count} device(s) will be changed',
    stableOneWay:
      'Turning stable mode off does not put these back — we do not know what you wanted them set to. Change them in the emulator’s own settings instead.',
    stableItem: {
      highFrameRate: 'High frame rate',
      keepAlive: 'Background keep-alive',
      verticalSync: 'Vertical sync',
      displayFps: 'On-screen FPS overlay',
      autoRotate: 'Auto-rotate',
      vramStrategy: 'VRAM usage policy',
    },
    createInstance: 'New instance',
    createTitle: 'Create emulator instance',
    create: 'Create',
    createOnPath: 'Create under',
    createName: 'Instance name',
    createNamePlaceholder: 'Leave empty to let the emulator name it',
    createHint: 'A device number is assigned automatically, appended after the existing ones.',
    ...
    removeWarning:
      'After removal, devices {slots} can no longer be reached through this config, affecting {count} script(s). Those device numbers are kept and will never be handed to another device — please pick a new device for the affected scripts.',
    removeRunningHint:
    ...
    reason: {
      ok: 'Can be added',
      version_too_old: 'Too old — upgrade to LDPlayer 14',
      planned: 'Coming in a later version',
      unsupported: 'Not supported',
      already_added: 'Already added',
      not_found: 'Emulator program not found',
    ...
    toast: {
      ...
      settingsFailed: 'Failed to save the settings',
      batchOk: 'Applied to {count} device(s)',
      ...
      deleteFailed: 'Failed to delete the instance',
      loadFailed: 'Failed to load the device list',
      searchFailed: 'Failed to search for emulators',
      addOk: 'Added {count} emulator(s)',
      removeOk: 'Emulator path removed',
      removeFailed: 'Failed to remove the emulator path',
    },
  },
  gamesign: {
    ...
    nav: {
      sign: 'Check-ins',
      activity: 'Daily notes',
    },
    activity: {
      title: 'Daily notes',
      queriedAt: 'Queried at {time}',
      refresh: 'Refresh daily notes',
    ...
    section: {
      ...
      privacyNotice:
        'When obtaining a token by QR code or password, MAS does not save the account, phone number, or password. Passwords exist only for the current request and are not written to config, logs, or notifications.',
    ...
    qr: {
      ...
      sklandTitle: 'Skland QR sign-in',
      alt: 'QR sign-in',
      hint: 'Open the Miyoushe app, tap the scan icon in the top left, and scan the code above',
      sklandHint: 'Open the Skland app, use Scan, and scan the code above',
      sklandWaiting: 'Scan the code with the Skland app',
      ...
      noCookie: 'The scan was confirmed, but the login flow returned incomplete credentials',
  ...
  init: {
    failure: {
      ...
      doctorEmpty: 'Nothing was checked',
      doctorFailed: 'The environment check failed: {error}',
      doctorRunning: 'Checking the environment...',
      details: 'Details',
      mirrorTitle: 'Retry with a different source',
      mirrorRecommended: 'Recommended',
    },
    steps: {
      environment: 'Environment',
      repository: 'Program files',
    ...
    backend: {
      ...
      viewDocs: 'Open the troubleshooting guide',
      notRunning: 'The backend service is not running',
    },
    step: {
      failed: '{title} failed',
      skip: 'Skip this step',
      skipConsequence: '(the app may not work properly)',
      retryWithMirror: 'Retry with another source',
      retry: 'Retry',
    },
  },
  misc: {
  ...
  scripts: {
    ...
    create: {
      ...
      typeDesc: {
        ...
        MaaFWManaged: 'AUTO-MAS imports and slims the project, dropping the GUI shell and bundled Python; scripts share one runtime',
  ...
  setting: {
    ...
    advanced: {
      ...
      runtimeLaunchModeEffective: 'Currently effective: {mode}',
