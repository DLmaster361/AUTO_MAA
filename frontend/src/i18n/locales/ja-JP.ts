...
export default {
  ...
  edit: {
    ...
    bettergiGroupKindKeyMouse: '録画',
    bettergiGroupKindPathing: '経路',
    bettergiGroupKindScriptGroup: '構成グループ',
    ...
    bettergiKeyMouseEmptyDir: '録画フォルダが空です',
    ...
    bettergiOpenBgi: 'BetterGI を開く',
    bettergiOpenKeyMouseDir: '録画フォルダを開く',
    bettergiOpenScriptDir: 'スクリプトフォルダを開く',
    bettergiOpenScriptGroupDir: '構成グループフォルダを開く',
    bettergiOpenScriptRepo: 'スクリプトリポジトリを開く',
    bettergiOpenTaskDir: 'パスフォルダを開く',
    ...
    bettergiRenameDone: '「{name}」に名前を変更しました',
    bettergiRenameLockedTip:
      'デフォルト・専用の設定グループはシステム名のままです。名称メモのみ変更できます',
    bettergiRenameNameLabel: '設定グループ名',
    bettergiRenameNamePlaceholder: '設定グループ名を入力',
    bettergiRenameOk: '名前変更',
    bettergiRenamePlaceholder: '任意、同名設定グループの複数インスタンスを区別するためのメモ',
    bettergiRenameSource: '実際のグループ名',
    bettergiRenameSuffixLabel: '名称メモ',
    bettergiRenameTip:
      '「設定グループ名」はこのページの表示のみを変更し、実行時は実際のグループ名が使われます。「名称メモ」は同名設定グループの複数インスタンスを区別します。',
    bettergiRenameTitle: '設定グループ名の編集',
    ...
    bettergiTabKeyMouse: '録画',
    bettergiTabScriptGroup: '構成グループ',
