...
export default {
  ...
  edit: {
    ...
    managed: {
      ...
      notImportedDesc:
        '管理スクリプトのプロジェクトは AUTO-MAS が取り込み、GUI シェル・同梱 Python・MaaFramework を外して軽量化します。実行環境は他のスクリプトと共有されます。下でローカルのプロジェクトフォルダか ZIP を指定して取り込んでください。',
      project: 'プロジェクト',
      version: 'バージョン',
      payloadSize: '使用量',
      size: 'サイズ',
      lastUsed: '最終使用',
      action: '操作',
      strippedTitle: '{saved}（{percent}%）を削減しました',
      strippedDesc: '除去したシェル：{shells}／除外パス {count} 件',
      viewExcluded: '除外された内容を見る',
      sourcePath: 'プロジェクトフォルダまたは ZIP',
      sourcePlaceholder: '例：D:\\downloads\\M9A-win-x86_64-v4.6.0 または同名の .zip',
      import: '取り込む',
      ...
      switchTo: '切り替え',
      delete: '削除',
      deleteTitle: 'バージョン {version} を削除しますか？',
      deleteContent: 'そのバージョンのファイルだけを削除します。設定と他のバージョンには影響しません。',
      deleteBlocked: 'このバージョンは削除できません',
      excludedTitle: '除外された内容',
      excludedPath: 'パス',
      excludedReason: '理由',
    },
    ...
    bettergiMasConfigTooltip:
      'ユーザー独立設定：このユーザーの一条龍タスクとカスタム設定グループはすべてこのページ（MAS 側）で設定します。BetterGI の「一条龍」ページを編集する必要はありません。',
    ...
    bettergiCustomGroupsTip3:
      '「設定グループを追加」では、既存の BetterGI 設定（独立設定モードではこのユーザーの MAS 独立コピー）から管理対象のグループを選びます。表に入れていないグループも一条龍に残り、この表が原因で失われることはありません。',
    ...
    bettergiAddScriptToGroup: 'グループにスクリプトを追加',
    bettergiAddScriptToGroupOk: '追加',
    bettergiAddScriptUnsupported: 'この種類は設定グループに追加できません',
    bettergiAddToDragon: '一条龍に追加',
    bettergiAddToDragonOk: '追加',
    bettergiAlreadyInDragon: 'すでに一条龍キューに追加されています',
    bettergiChipSelectHint: 'キューに追加する項目を選択',
    bettergiClearDragon: '一条龍をクリア',
    bettergiClearDragonTitle: '一条龍キューをクリアしますか？',
    bettergiCopySameAs: '同じ設定をコピー',
    bettergiDuplicateAsNew: '新しい設定グループとして保存',
    bettergiDuplicateDone: '新しい設定グループとして保存しました',
    bettergiDuplicateNamePlaceholder: '新しい設定グループ名',
    ...
    bettergiGroupKindCustom: 'カスタム',
    bettergiGroupKindPathing: '経路',
    bettergiGroupKindScriptGroup: 'スクリプトグループ',
    ...
    bettergiGroupSettingsSaved: '設定グループを保存しました',
    bettergiGroupStamina: 'スタミナ',
    bettergiInQueue: 'キュー内',
    bettergiInputGroupNames: '設定グループ名を入力',
    bettergiInputGroupNamesTip: '複数の名前は改行またはカンマで区切ります',
    bettergiMultiDisable: '選択を無効化',
    bettergiMultiEnable: '選択を有効化',
    bettergiMultiRemove: '選択を削除',
    bettergiMultiRemoveContent: '削除するとこれらの設定グループは一条龍では実行されなくなります',
    bettergiMultiRemoveTitle: '選択した設定グループを削除しますか？',
    bettergiMultiSelected: '{count} 件選択中',
    bettergiOpenBgi: 'BetterGI フォルダを開く',
    bettergiOpenOneDragonDir: '一条龍フォルダを開く',
    bettergiOpenScriptDir: 'スクリプトフォルダを開く',
    bettergiOpenScriptGroupDir: 'スクリプトグループフォルダを開く',
    bettergiOpenScriptRepo: 'スクリプトリポジトリを開く',
    bettergiOpenTaskDir: 'タスクフォルダを開く',
    bettergiPathingEmptyDir: '経路フォルダが空です',
    bettergiPathingEmptyTree: '経路リストが空です',
    bettergiPathingSelectHint: '追加する経路を選択',
    bettergiPickCandidateFirst: 'まず候補を選択してください',
    bettergiProjectSaveFailed: 'プロジェクトの保存に失敗しました',
    bettergiRemoveFromDragonContent: '削除するとこの設定グループは一条龍では実行されなくなります',
    bettergiRemoveFromDragonTitle: '一条龍キューからこの項目を削除しますか？',
    bettergiRenameAsNew: '設定グループ名を変更',
    bettergiRenameDone: '名前を変更しました',
    bettergiRenameOk: '名前変更',
    bettergiRenamePlaceholder: '設定グループ名',
    bettergiRenameSource: '元の名前',
    bettergiRenameTip: '選択した設定グループの表示名を変更します',
    bettergiRenameTitle: '設定グループ名の変更',
    bettergiScriptGroupEmptyDir: 'スクリプトグループフォルダが空です',
    bettergiStrategyPickerTip: '一条龍の共通バトルストラテジーを選択',
    bettergiTabJsEmpty: 'JS スクリプトはありません',
    bettergiTabJsScript: 'JS スクリプト',
    bettergiTabPathing: '経路',
    bettergiTabScriptGroup: 'スクリプトグループ',
    bettergiDomainPickerClear: 'クリア',
    bettergiDomainPickerClearAll: 'すべてクリア',
    bettergiDomainPickerClearAllConfirm: '選択した秘境をすべてクリアしますか？',
    bettergiDomainPickerNone: '選択可能な秘境はありません',
    bettergiDomainPickerOk: 'OK',
    bettergiDomainPickerTitle: '秘境選択',
    bettergiGroupSettingsPlaceholder: '選択',
    bettergiGroupSettingsTitle: '設定グループの設定',
    bettergiGroupSettingsZoom: 'ズーム',
    bettergiProjectAddScript: 'スクリプトを追加',
    bettergiProjectClearSelection: '選択をクリア',
    bettergiProjectConfigTab: 'スクリプト設定',
    bettergiProjectEmpty: 'プロジェクトはありません',
    bettergiProjectIndependentSaveLater: '後でスクリプトグループで個別に保存されます',
    bettergiProjectListTip: 'プロジェクトを選択して設定を表示・編集',
    bettergiProjectLoadFailed: 'プロジェクトの読み込みに失敗しました',
    bettergiProjectMultiHint: '複数のプロジェクトが選択されています',
    bettergiProjectNoSettingsFile: '設定ファイルがありません',
    bettergiProjectReadmeEmpty: 'README は空です',
  ...
  emulator2: {
    ...
    colSource: '取得元',
    colSlot: 'デバイス番号',
    nativeIndex: 'インスタンス {index}',
    footerHint:
      '設定はいつでも変更でき、次回起動時に反映されます。起動 / 終了 / 非表示とスクリプト呼び出しは従来どおりです。',
    colResolution: '解像度',
    colCpu: 'CPU',
    colMemory: 'メモリ (MB)',
    colFps: 'フレームレート',
    ...
    settingsHint:
      '次回起動時に反映されます。実行中のインスタンスは現在の構成のままです。空欄の項目は変更されません。',
    save: '保存',
    keepCurrent: '変更しない',
    fieldWidth: '幅',
    fieldHeight: '高さ',
    ...
    stableOn: 'オン',
    stableOff: 'オフ',
    stableTitle: '安定モードを有効にする',
    stableApply: '安定モードを有効にする',
    stableAlready: 'このインスタンスは既に安定モードです',
    stableIntro:
      'スクリーンショット認識を妨げるエミュレーターの機能を無効にします。スクリプトは画像認識と固定座標のタップに依存しており、これらの機能はその前提を壊します。',
    stableNothing: 'すべてのデバイスが既に安定モードです',
    stableWillChange: '{count} 台のデバイスを変更します',
    stableOneWay:
      '安定モードを解除しても元の値には戻しません。元に戻したい場合はエミュレーター側の設定で変更してください。',
    stableItem: {
      highFrameRate: '高フレームレート',
      keepAlive: 'バックグラウンド常駐',
      verticalSync: '垂直同期',
      displayFps: 'フレームレート表示',
      autoRotate: '自動回転',
      vramStrategy: 'ビデオメモリ使用方針',
    },
    createInstance: 'インスタンスを作成',
    createTitle: 'エミュレーターのインスタンスを作成',
    create: '作成',
    createOnPath: '作成先',
    createName: 'インスタンス名',
    createNamePlaceholder: '空欄の場合はエミュレーターが命名します',
    createHint: '作成すると既存の番号の後ろにデバイス番号が自動で割り当てられます。',
    deleteInstance: '削除',
    ...
    removeWarning:
      '削除するとデバイス {slots} はこの設定から利用できなくなり、{count} 個のスクリプトに影響します。これらのデバイス番号は保持され、他のデバイスに割り当てられることはありません。影響するスクリプトには別のデバイスを選び直してください。',
    removeRunningHint:
      'うち {count} 個は実行中です。削除後、次回の実行は失敗し、デバイスの選び直しを求められます。',
    affectedScripts: '影響するスクリプト',
    running: '実行中',
    colDpi: 'DPI',
    managePaths: 'エミュレーターを管理',
    pathsEntryHint: 'この設定が管理するエミュレーターのインストールを追加・削除します',
    stableSwitchTip:
      'スクリーンショット認識を妨げる機能（高フレームレート、バックグラウンド常駐、垂直同期、フレームレート表示、自動回転、MuMu のビデオメモリ方針）を無効にします。オンの間はインスタンス起動のたびに適用されるため、新しいインスタンスにも反映されます。オフにしても元の値には戻しません。',
    busy: {
      creating: '作成中',
      deleting: '削除中',
      operating: '処理中',
    ...
    reason: {
      ok: '追加できます',
      version_too_old: 'バージョンが古いため LDPlayer 14 へ更新してください',
      planned: '今後のバージョンで対応',
      unsupported: '未対応',
      already_added: '追加済み',
      not_found: 'エミュレーター本体が見つかりません',
    ...
    toast: {
      ...
      deleteFailed: 'インスタンスの削除に失敗しました',
      loadFailed: 'デバイス一覧の読み込みに失敗しました',
      searchFailed: 'エミュレーターの検索に失敗しました',
      addOk: '{count} 個のエミュレーターを追加しました',
      removeOk: 'エミュレーターのパスを削除しました',
      removeFailed: 'エミュレーターのパスの削除に失敗しました',
    },
  },
  gamesign: {
    title: 'ゲームコミュニティ',
  ...
  home: {
    ...
    quickStart: {
      ...
      startFailedItems: '次のタスクを開始できませんでした: {p0}',
  ...
  launch: {
    starting: '起動しています',
    retrying: '起動し直しています',
    retryingHint: '前回は起動できませんでした。もう一度試しています',
    preparing: '実行環境を準備しています',
    updating: '更新しています',
  ...
  init: {
    failure: {
      ...
      doctorEmpty: '確認できた項目がありません',
      doctorFailed: '実行環境の確認に失敗しました: {error}',
      doctorRunning: '実行環境を確認しています...',
      details: '詳細',
      mirrorTitle: '別のダウンロード元で再試行',
      mirrorRecommended: '推奨',
    },
    steps: {
      environment: '実行環境',
      repository: 'プログラムファイル',
      dependency: '依存関係',
      backend: '起動',
    },
    msg: {
    ...
    step: {
      ...
      skip: 'このステップをスキップ',
      skipConsequence: '（アプリが正常に動作しない可能性があります）',
      retryWithMirror: '別のダウンロード元で再試行',
      retry: '再試行',
    },
  },
  misc: {
  ...
  queue: {
    ...
    typeCycle: '循環キュー',
    cycleLocked:
      '循環実行中のため、キューの種類とタスクの追加・削除・並び替えは停止するまで変更できません',
    scheduled: '定時実行',
  ...
  scripts: {
    ...
    create: {
      ...
      typeDesc: {
        ...
        MaaFWManaged: 'AUTO-MAS がプロジェクトを取り込み、GUI シェルと同梱 Python を削って軽量化し、実行環境を共有します',
  ...
  setting: {
    ...
    display: {
      section: '仮想ディスプレイ',
      intro:
        '実際の映像出力がすべて失われると、Windows はプレースホルダーの幻影ディスプレイだけを残します。見かけ上は正常な解像度を報告しますが、実際には何も出力しておらず、ゲームの描画も画面キャプチャも信頼できません。出力が無い状態でのコールドブートはさらに厄介で、非常に低い解像度で起動し、縮んだウィンドウサイズがゲームに記憶されます。有効にすると、MAS はデスクトップを常時監視し、実際の映像出力が一つも無くなると仮想ディスプレイを接続し、実際のモニターが復帰すると自動的に取り外します。タスクの実行中はそのタスクが終わるまで待つため、実行中のスクリプトから画面を奪うことはありません。{driverLink}。MAS には同梱されていません。',
      introDriverLink: 'Parsec 仮想ディスプレイドライバーは各自でインストールしてください',
      enable: '仮想ディスプレイを有効化',
      enableTip:
        'MAS の実行中は常時監視します。実際の映像出力を検出できないときに接続し、実際のモニターが復帰すると取り外します（タスクの実行中はそのタスクが終わってから）。モニターが正常に動作していれば追加しません。プログラムが強制終了された場合は次回起動時に残ったディスプレイを片付けます。',
      mode: 'リフレッシュレート',
      modeTip:
        '解像度は 1920x1080 に固定です。Windows が 100% で表示するのはこの解像度だけで、ゲームウィンドウが DPI スケーリングを経由しません。これより高い解像度は自動的に拡大され、問題が戻ってきます。仮想ディスプレイはスクリプト実行専用のため、高リフレッシュレートに意味はありません。',
      refreshDefault: '推奨',
      refreshLowPower: 'GPU 負荷が軽い',
      check: 'ドライバー診断',
      checkTip:
    ...
    advanced: {
      ...
      runtimeLaunchModeEffective: '現在の適用値: {mode}',
